...
(function($) {
  return $.fn.jfontsize = function(opcoes) {
    ...
    apply();
    $(opcoes.btnMinusClasseId).bind("click",function() {
    ...
    $(opcoes.btnMinusClasseId).bind("keypress",function(event) {
      $(opcoes.btnPlusClasseId).removeClass("jfontsize-disabled");
	  if ( event.which == 13 ) {
      if (current_size > (-opcoes.btnMinusMaxHits)) {
        current_size--;
    ...
    $(opcoes.btnDefaultClasseId).bind("click",function() {
    ...
    $(opcoes.btnDefaultClasseId).bind("keypress",function(event) {
      $(opcoes.btnMinusClasseId).removeClass("jfontsize-disabled");
      $(opcoes.btnPlusClasseId).removeClass("jfontsize-disabled");
	  if ( event.which == 13 ) {
      current_size = 0;
    ...
    $(opcoes.btnPlusClasseId).bind("click",function() {
      $(opcoes.btnMinusClasseId).removeClass("jfontsize-disabled");
      if (current_size < opcoes.btnPlusMaxHits) {
        current_size++;
        if (current_size === opcoes.btnPlusMaxHits) {
    ...
    return $(opcoes.btnPlusClasseId).bind("keypress",function(event) {
      $(opcoes.btnMinusClasseId).removeClass("jfontsize-disabled");
	  if ( event.which == 13 ) {
      if (current_size < opcoes.btnPlusMaxHits) {
        current_size++;
